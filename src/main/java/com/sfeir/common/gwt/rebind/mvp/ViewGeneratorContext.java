...
public class ViewGeneratorContext {
	public static ViewGeneratorContext create(TreeLogger logger, TypeOracle typeOracle, String suffixName) throws UnableToCompleteException {
		JClassType viewType = requireType(typeOracle, View.class);
		return new ViewGeneratorContext(logger, typeOracle, viewType, suffixName);
	}
	...
	ViewGeneratorContext(TreeLogger logger, TypeOracle typeOracle, JClassType viewType, String suffixName) {
		this.logger = logger;
