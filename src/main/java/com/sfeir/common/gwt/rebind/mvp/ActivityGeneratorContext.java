...
class ActivityGeneratorContext {
	static ActivityGeneratorContext create(TreeLogger logger, TypeOracle typeOracle) throws UnableToCompleteException {
		...
		return new ActivityGeneratorContext(logger, typeOracle, activityPresenterType, activityType, placeType);
	}
	...
	ActivityGeneratorContext(TreeLogger logger, TypeOracle typeOracle, JClassType activityPresenterType, JClassType activityType, JClassType placeType) {
		this.logger = logger;
	...
	private void initActivities() throws UnableToCompleteException {
		...
		for (JClassType activityType : subtypes) {
			IgnoreActivity ignoreActivity = activityType.getAnnotation(IgnoreActivity.class);
